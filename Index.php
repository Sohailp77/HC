            ...
            <div class="panel-body">
                ...
                <table border="0" class="table table-bordered">
                    ...
                    <td align='center' colspan='6'>
                        <input type="radio" name="Task_type" value="T"  checked onclick="loadPage('Index.php')">
                        <span id="label_fsearch_case">To Do</span>
                        &nbsp;&nbsp;&nbsp;
                        <input type="radio" name="Task_type" value="R"  onclick="loadPage('Reminder.php')">
                ...
                <input type="date" class="form-control" id="dateInput" name="dateInput" oninput="updateDayOfWeek()">
                    ...
                    <a class="btn btn-primary"  href="Index2.php">Task Scheduled</a>
